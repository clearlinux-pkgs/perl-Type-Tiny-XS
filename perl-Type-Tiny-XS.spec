...
Requires: perl-Type-Tiny-XS-lib
Requires: perl-Type-Tiny-XS-license
Requires: perl-Type-Tiny-XS-man
...
%package man
Summary: man components for the perl-Type-Tiny-XS package.
Group: Default

%description man
man components for the perl-Type-Tiny-XS package.
...
mkdir -p %{_topdir}/BUILD/Type-Tiny-XS-0.014/deblicense/
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-Type-Tiny-XS
cp LICENSE %{buildroot}/usr/share/doc/perl-Type-Tiny-XS/LICENSE
cp COPYRIGHT %{buildroot}/usr/share/doc/perl-Type-Tiny-XS/COPYRIGHT
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/x86_64-linux-thread-multi/Type/Tiny/XS.pm
/usr/lib/perl5/site_perl/5.26.1/x86_64-linux-thread-multi/Type/Tiny/XS/Util.pm

%files lib
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/x86_64-linux-thread-multi/auto/Type/Tiny/XS/XS.so

%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-Type-Tiny-XS/COPYRIGHT
/usr/share/doc/perl-Type-Tiny-XS/LICENSE
