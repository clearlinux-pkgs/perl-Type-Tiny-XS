...
Version  : 0.019
Release  : 16
URL      : https://cpan.metacpan.org/authors/id/T/TO/TOBYINK/Type-Tiny-XS-0.019.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/T/TO/TOBYINK/Type-Tiny-XS-0.019.tar.gz
...
%prep
%setup -q -n Type-Tiny-XS-0.019
cd %{_builddir}/Type-Tiny-XS-0.019
...
cp %{_builddir}/Type-Tiny-XS-0.019/LICENSE %{buildroot}/usr/share/package-licenses/perl-Type-Tiny-XS/fe949ecf1e34d3c41d26feec5553d225755faf79
if test -f Makefile.PL; then
